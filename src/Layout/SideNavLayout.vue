<template>
  <div>
    <nav :class="['navbar fixed-top', isOpen ? 'top-navbar' : 'top-navbar-expand']" id="topNav">
      <div class="container-fluid">
        ...
        <button class="btn btn-danger">
          <span class="side-bar-item-icon"><i class="fa fa-sign-out-alt text-white" /></span>
    ...
    <div :class="isOpen ? 'side-nav-open' : 'side-nav-close'" id="sideNav">
      <router-link href="/dashboard" class="side-bar-item">
